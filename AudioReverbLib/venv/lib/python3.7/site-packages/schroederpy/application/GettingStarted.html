<html>
    <head>
        <title>Getting Started with the schroederpy Python Package</title>
        <style type="text/css">
    ...
    <body>
        <div class = rtcContent>
            <h1  class = 'S0'><span>Getting Started with the schroederpy Python Package</span></h1>
            ...
            <h2  class = 'S2'><span>Location of Installed Python Package Files</span></h2>
                <div  class = 'S1'><span><a href=".">View schroederpy Files</a></span></div>
                <div  class = 'S1'><span></span></div>
                <div  class = 'S1'><span></span></div>
            ...
            <h2  class = 'S2'><span>Executing Python Driver Applications</span></h2>
                <div  class = 'S1'><span>At the system terminal, type:</span></div>
                <div  class = 'code'><pre>mwpython driverApplication.py</pre></div>
                <div  class = 'S1'><span><a href="https://www.mathworks.com/help/compiler_sdk/python/mwpython.html">Learn more about mwpython</a></span></div>
                <div  class = 'S1'><span></span></div>
